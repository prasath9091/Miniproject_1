            ...
            try:
                ...
                if "jarvis" in spoken_text.lower():
                    ...
                    if "can you hear me" in spoken_text.lower():
                        ...
                        engine.say("What event would you like to schedule?")
                        engine.runAndWait()

                        audio_data = recognizer.listen(source, timeout=None)
                        event_name = recognizer.recognize_google(audio_data).lower().strip()

                        engine.say(f"When do you want to schedule {event_name}?")
                        engine.runAndWait()
